...
enum Criterion: string
{
    ...
    public function rationale(): string
    {
        return match ($this) {
            ...
            self::StandDensity => 'La surface terrière est le prédicteur de peuplement le plus corrélé aux récoltes (optimum souvent vers 15–20 m²/ha). Ici on n’a que le proxy BD Forêt FO/FF (ouvert vs fermé).',
    ...
    /**
     * Expert-elicited priors re-challenged août 2026 after adding stand density + geology.
     * Must sum to 1.0 — see AGENTS.md.
     */
