...
enum Criterion: string
{
    ...
    public function rationale(): string
    {
        return match ($this) {
            ...
            self::Geology => 'Le pH du sol oriente le cortège (trompette / morille plutôt basiques, girolle plutôt acides). Source nominale : EcoDataCube 30 m ; repli Charm-50 BRGM si le raster manque.',
